 ...
 */
public class LivroAutor extends javax.swing.JDialog {

    /**
     * Creates new form LivroAutor
     */
    public LivroAutor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.add("Livro", new MLIVRO());

        jTabbedPane1.add("Autor", new DetalheLAUTOR());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LivroAutor dialog = new LivroAutor(new javax.swing.JFrame(), true);
